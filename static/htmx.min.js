var htmx = function () {
  ...
  function le(e) {
    ...
    if (t && t instanceof window.ShadowRoot) return ne().body.contains(t.host);
    else return ne().body.contains(e);
  }
  function F(e) {
  ...
  function p(e, t, n) {
    e = y(e);
    if (t.indexOf("closest ") === 0) return [g(ue(e), ge(t.substr(8)))];
    else if (t.indexOf("find ") === 0) return [r(f(e), ge(t.substr(5)))];
    else if (t === "next") return [ue(e).nextElementSibling];
    else if (t.indexOf("next ") === 0) return [pe(e, ge(t.substr(5)), !!n)];
    else if (t === "previous") return [ue(e).previousElementSibling];
    else if (t.indexOf("previous ") === 0) return [me(e, ge(t.substr(9)), !!n)];
    else if (t === "document") return [document];
    else if (t === "window") return [window];
    else if (t === "body") return [document.body];
    else if (t === "root") return [m(e, !!n)];
    else if (t === "host") return [e.getRootNode().host];
    else if (t.indexOf("global ") === 0) return p(e, t.slice(7), true);
    else return M(f(m(e, !!n)).querySelectorAll(ge(t)));
  }
  ...
  function y(e, t) {
    if (typeof e === "string") return r(f(t) || document, e);
    else return e;
  }
  function xe(e, t, n, r) {
    if (k(t)) {
  ...
  function Je(e, t, n) {
    ...
    if (r.indexOf("{") === 0) {
      ...
      const s = r.split(",");
      for (let e = 0; e < s.length; e++) de(n, s[e].trim(), []);
    }
  }
  const Ke = /\s/;
  const b = /[\s,]/;
  ...
  function st(e) {
    ...
    else if (d(e, "form")) return [{ trigger: "submit" }];
    else if (d(e, 'input[type="button"], input[type="submit"]')) {
      return [{ trigger: "click" }];
    } else if (d(e, ot)) return [{ trigger: "change" }];
    ...
    se(t, function (i) {
      const s = function (e) {
        ...
        if (t.handledFor.indexOf(l) < 0) {
          ...
          if (u.target && e.target) { if (!d(ue(e.target), u.target)) return; }
          if (u.once) {
  ...
  function St(r, e, t, n) {
    if (e.trigger === "revealed") {
      ...
      if (!gt(e, r, Mt("load", { elt: r }))) vt(ue(r), n, t, e.delay);
  ...
  function Rt(e) {
    const t = [];
    if (e instanceof DocumentFragment) { for (const n of e.childNodes) {
        Ot(n, t);
      } } else Ot(e, t);
    return t;
  }
  ...
  function Pt(t) {
    ...
    if (n.initHash !== Pe(t)) {
      ...
      const r = wt(t, n, e);
      if (!r) {
        if (re(t, "hx-boost") === "true") ft(t, n, e);
    ...
    if (n) {
      ...
      if (s.length > 0) {
        for (let e = 0; e < s.length; e++) {
          const l = s[e];
          if (l.indexOf("swap:") === 0) r.swapDelay = h(l.substr(5));
          else if (l.indexOf("settle:") === 0) r.settleDelay = h(l.substr(7));
          ...
          else C("Unknown modifier in hx-swap: " + l);
        }
      }
    }
    return r;
  ...
  function Rn(t, n, r) {
    ...
    if (r) {
      if (r instanceof Element || typeof r === "string") {
        ...
        let e = y(r.target);
        if (r.target && !e || !e && !y(r.source)) e = ve;
    ...
    } else return he(t, n, null, null, { returnPromise: true });
  }
  function Hn(e) {
    const t = [];
    while (e) {
  ...
  function Nn(r) {
    return new Proxy(r, {
      get: function (e, t) {
        ...
        if (t === "toJSON") return () => Object.fromEntries(r);
        if (t in e) {
  ...
  function he(t, n, r, o, i, D) {
    ...
    if (a) {
      ...
      if (N != null) { if (N.toLowerCase() !== "dialog") t = N; }
    }
    ...
    if (h) {
      ...
      } else if (h === "replace") de(d, "htmx:abort");
    ...
    if (u.xhr) {
      if (u.abortable) de(d, "htmx:abort");
      else {
        if (g == null) {
          if (o) {
            const P = ie(o);
  ...
  function Dn(o, i) {
    ...
    if (O(s, /HX-Trigger:/i)) Je(s, "HX-Trigger", o);
    ...
    if (O(s, /HX-Reswap:/i)) g = s.getResponseHeader("HX-Reswap");
    var p = s.response;
    var m = ce({
      shouldSwap: a,
      serverResponse: p,
    ...
    if (m.shouldSwap) {
      ...
      if (u.type) zt();
      var x = gn(o, g);
      if (!x.hasOwnProperty("ignoreTitle")) x.ignoreTitle = d;
      l.classList.add(Q.config.swappingClass);
      let n = null;
      let r = null;
      if (c) h = c;
      if (O(s, /HX-Reselect:/i)) h = s.getResponseHeader("HX-Reselect");
      ...
      if (
        t && de(o, "htmx:beforeTransition", i) &&
